"""
Django settings for ItemsPro project.
...
SECRET_KEY = 'django-insecure-umh)cb991=!6p&g54f9e0&jx(7&a4(^%judz+$f!=ljii5o8u+'
...
WSGI_APPLICATION = 'ItemsPro.wsgi.application'
